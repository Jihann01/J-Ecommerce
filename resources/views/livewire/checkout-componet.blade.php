							...
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									...
									<p class="row-in-form">
										...
										<input  type="text" name="country" value="" placeholder="Morocco" wire:model="country">
							...
							<div class="col-md-12">
								<div class="wrap-address-billing">
									...
									<div class="billing-address">
										...
										<p class="row-in-form">
											<label for="city">Region<span>*</span></label>
											<input type="text" name="city" value="" placeholder="province name" wire:model="s_province">
						...
						<div class="summary-item payment-method">
							...
							<div class="wrap-address-billing">
								<p class="row-in-form">
									...
									<input  type="text" name="card_no" value="" placeholder="Your card number" wire:model="card_no">
									@error('s_zipcode') <span class="text-danger">{{$message}}</span> @enderror
								</p>
								...
								<p class="row-in-form">
									<label for="exp-year">Expirt Year:</label>
							...
							<div class="choose-payment-methods">
								...
								<p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">$456</span></p>
